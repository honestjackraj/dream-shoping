            ...
            <div className="homecard-full">
                <div className="container text-center">
                    <div className="row">
                        <div className="col">
                            <div className="card" >
                                <img src="./image/card/card1.jpg.webp" className="card-img-top" alt=".image" />
                        ...
                        <div className="col">
                            <div className="col">
                                <div className="card" >
                                    <img src="./image/card/card2.jpg.webp" className="card-img-top" alt=".image" />
                        ...
                        <div className="col">
                            <div className="col">
                                <div className="card" >
                                    <img src="./image/card/card3.jpg.webp" className="card-img-top" alt=".image" />
                                    <Link to="#" className="btn btn-light card-prize ">SHOP NOW</Link>
                                </div>
                            </div>
                        </div>
